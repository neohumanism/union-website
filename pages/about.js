...
const AboutCards = [
  {title: "Who we are", desc: "We are an organization with ambitions to establish a new global order. The world is not in a good state, proponents of the current order are either helpless or actively leading us astray. None of the necessary changes we hoped for have appeared, and we could not find any group that championed the necessary changes, so we have taken that duty upon ourselves - The duty to supplant the old order, avert the present crisis, and steer society to its greatest potential."},
  {title: "Our values", desc: "We are seekers of true meaning, and hold most of what is to be mere distractions, be it worldly pleasures or personal grievances. We believe the purpose of society, science, and progress is to realize true meaning, and therefore place our significance in them."},
  {title: "This website", desc: "Here, we explain our cause and argue to those with sympathies for why they should further support it. Most of the general population do value the futures of their children and hold themselves to moral standards. This is our appeal to explain the risks abound of our current situation, and why with their values considered in earnest, they should be lead to the same conclusions as us."},
